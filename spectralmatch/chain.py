...
def pipeline(
    ...
    *,
    ...
    shared_image_processing_backend: Universal.ImageProcessingBackend = "local",
    ...
    Universal._validate(
        ...
        image_processing_backend=shared_image_processing_backend,
    ...
    results: dict[str, Any] = {
        ...
        "shared_image_processing_backend": shared_image_processing_backend,
